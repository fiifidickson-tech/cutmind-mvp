...
It ensures engineers clearly understand the expected request/response formats
before implementation begins.

The API contract acts as a shared agreement between:
- Backend developers
- Frontend developers
- Anyone intergrating with the system
...
### Description
Converts natural-language instructions into structured rules JSON.
...
{
  "rules": [
    { "operations": "crop_hem", "value_cm": 5 },
